(* E11 - For noForth C&V 200202: Bitbang SPI-like on MSP430G2553 at port-2.
  ...
  Note that: You may use common anode or common cathode displays.
    Common anode displays have a common VCC connection, common
    cathode displays have a common ground connection!

  **** THIS CODE IS FOR A COMMON ANODE DISPLAY ****
...
: >DISPLAY          ( u -- )            ( Send number u to digits )
    12 umin  numbers   +                ( From binary to ca 7-segment )
    c@  >driver  show ;                 ( And show it ! )
