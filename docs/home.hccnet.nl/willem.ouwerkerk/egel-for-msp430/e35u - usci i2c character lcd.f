(* E35U - For noForth C&V2553 lp.0, USCI I2C on MSP430G2553 using port-1.
...
: !LCD      ( bitmap -- )               \ Send bitmap to 86014 module
    4E {i2write  light 8 and            \ with dev. address 4E, Backlight?
    or i2out1  i2stop} ;                \ add to databyte & ready
