(* E21 - For noForth C2553 lp.0, C&V version: Load noforth-asm.f first !
...
code SERVO-INT  ( -- )      \ 6 - interrupt call
    ...
    day ) 021 & .b bis      \ 5 - 2 P1OUT  Set bit on (P1)
\ Now the piece that resets previous servo pulse
    ...
    day ) 021 & .b bic      \ 5 - 2 P1OUT  Reset previous bit (P1)
\ To next servo
...
: SERVO-ON  ( -- )          \ Initialise servo hardware
    030 022 *bis            \ P1DIR    Bit P1.4 and P1.5 outputs
