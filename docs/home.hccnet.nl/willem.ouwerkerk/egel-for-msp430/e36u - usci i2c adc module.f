(* E36U - For noForth C&V2553 lp.0, bitbang I2C on MSP430G2553 using port-1.
...
: ADC       ( +n -- u )
    090 {i2write                    \ send dev. write address
...
: DAC       ( u -- )
    ...
    090 {i2write  40 i2out1         \ send dev. write address & control byte
